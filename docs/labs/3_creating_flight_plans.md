...
In this lab, you will work with your group to create an aerial mapping flight plan using a set of mission constraints provided by the instructor or TAs.

Your goal is to develop a flight plan that satisfies the mission requirements while also considering the quality of the imagery that will be collected.
...
9. Create a flight plan that satisfies the provided mission requirements.
10. Document and justify the major decisions used in the flight plan.
...
2. Mission-planning software or website specified by the instructor
3. Mission area provided by the instructor or TAs
4. Mission constraints provided during the lab
...
This lab will focus on creating a flight plan for an aerial mapping mission.

You will work in groups to:

1. Review the mission area.
2. Review the constraints provided by the TAs.
3. Define the objective of your mission.
4. Select appropriate flight parameters.
5. Create a proposed mapping flight path.
6. Review the estimated flight time.
7. Adjust the flight plan as needed.
8. Compare your plan with the mission requirements.
9. Document and justify your final decisions.

The goal is not to create one single "correct" flight plan.

Different groups may develop different solutions while still satisfying the same mission requirements.

!!! note "Mission Constraints"
    The constraints shown in this lab are provided as an example of the types of requirements that may affect a mission plan.

    The actual constraints for your flight will be provided by the instructor or TAs during the lab.

    Always use the constraints given during your lab session when creating your final flight plan.
...
!!! warning "Use the Lab Constraints"
    ...
    The instructor or TAs will provide the **actual mission area and constraints** during the lab.
