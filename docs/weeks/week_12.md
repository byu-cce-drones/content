...
!!! abstract "This week"
    ...
    - **Thursday:** project flights for **Group B**. Group A does not meet this Thursday; it flew last week.

The Tuesday surveying and trigonometry review material will be posted here once it is written.

## Thursday's flights

Group B flies this week. The flights are still governed by [Flight and Data Processing](../final_project/flight_and_data_processing.md).
